...
export { default as ResidentesList } from './ResidentesList';
export { default as ResidenteDetail } from './ResidenteDetail';
export { default as ResidenteForm } from './ResidenteForm';